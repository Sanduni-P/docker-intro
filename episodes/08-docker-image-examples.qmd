...
In this GitHub Actions example, you can learn more about
continuous integration in the cloud and how you can use container images with GitHub to
automate repetitive tasks like testing code or deploying websites. Our specific
example will show a
...
::: {.callout-note .solution-callout icon="false" style="border-left: 4px solid #ffc107;" collapse="true"}
...
<table style="width: 100%; border: none;">
	<tr>
		<td style="text-align: left; width: 50%;">
			[← Previous](../episodes/07-advanced-containers.qmd)
		</td>
		<td style="text-align: right; width: 50%;">
			[Next →](../episodes/09-reproduciblity.qmd)
		</td>
	</tr>
</table>
