...
into the built container image [more details in the next episode](07-advanced-containers.qmd)
...
<table style="width: 100%; border: none;">
  <tr>
    <td style="text-align: left; width: 50%;">
      [← Previous](../episodes/05-docker-hub.qmd)
    </td>
    <td style="text-align: right; width: 50%;">
      [Next →](../episodes/07-advanced-containers.qmd)
    </td>
  </tr>
</table>
